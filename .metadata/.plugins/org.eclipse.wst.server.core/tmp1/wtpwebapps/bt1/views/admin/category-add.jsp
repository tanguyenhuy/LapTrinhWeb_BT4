                ...
                <div class="card-body p-4">
                    <form action="<c:url value='/admin/category/insert'/>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="categoryname" name="categoryname" 
                                       placeholder="Ví dụ: Điện thoại, Laptop..." required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-muted small">Nhập URL trực tiếp nếu dùng ảnh có sẵn trên mạng.</div>
                        </div>

                        <div class="mb-3">
                            <label for="images1" class="form-label fw-semibold">Hoặc tải file ảnh từ máy tính (Upload)</label>
                            <div class="input-group">
